        ...
        <Card level={1} className="p-6 sm:p-8 space-y-6">
          ...
          <ol className="relative border-l border-black/10 dark:border-white/10 ml-3 space-y-8">
            <li className="pl-8">
              ...
              <h3 className="text-sm font-semibold text-ink mb-1">Acesse as Configurações na Omie</h3>
            ...
            <li className="pl-8">
              ...
              <h3 className="text-sm font-semibold text-ink mb-1">Abra a área de Integração / API</h3>
            ...
            <li className="pl-8">
              ...
              <h3 className="text-sm font-semibold text-ink mb-1">Copie as Chaves</h3>
              <p className="text-xs text-ink-soft">
            ...
            <li className="pl-8">
              ...
              <h3 className="text-sm font-semibold text-ink mb-1">A mágica acontece em background</h3>
              <p className="text-xs text-ink-soft mb-2">
