...
import { ConciliacaoHero } from './ConciliacaoHero';
...
export default async function Page() {
  ...
  return (
    <div className="mx-auto w-full max-w-6xl space-y-16 animate-in fade-in">
      {/* 1. Hero do Sistema no padrão Bento, com métricas e navegação */}
      <ConciliacaoHero
