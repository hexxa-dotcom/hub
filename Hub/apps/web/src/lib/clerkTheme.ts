...
export const hexxaClerkAppearance = {
  ...
  // As classes de cor abaixo levam `!` (important) porque o Clerk injeta seu
  // próprio <style> em runtime DEPOIS do CSS estático do Tailwind — empatando
  // em especificidade (ambos são seletores de 1 classe), o CSS do Clerk vence
  // por ordem de carregamento e apaga as cores daqui (texto ilegível).
  elements: {
