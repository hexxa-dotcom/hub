        ...
        <div className="absolute right-0 top-full mt-2 w-72 origin-top-right rounded-3xl border border-black/10 dark:border-white/10 bg-[#F5F6F4] dark:bg-[#1A201C] p-2 shadow-2xl z-50 animate-fade-up">
            ...
            {ACTIONS.map((item) => {
                ...
                <>
                  ...
                  <div className="min-w-0 flex-1 text-left">
                    <div className="flex items-center gap-1.5">
                      <p className="text-xs sm:text-sm font-bold text-[#231F20] dark:text-[#F5F6F4] truncate leading-tight">
                        {item.label}
                      </p>
                    </div>
              ...
              if (item.drawer) {
                return (
                  <button
                    ...
                    className="flex w-full items-center gap-3 rounded-2xl p-2.5 hover:bg-[#E7EAE5] dark:hover:bg-white/5 transition-colors group"
                  >
                    {inner}
                  </button>
                );
              ...
              return (
                <Link
                  ...
                  className="flex items-center gap-3 rounded-2xl p-2.5 hover:bg-[#E7EAE5] dark:hover:bg-white/5 transition-colors group"
                >
                  {inner}
                </Link>
              );
          ...
          <div className="border-t border-black/5 dark:border-white/5 mt-1 pt-1">
            <Link
              ...
              onClick={() => setOpen(false)}
              className="flex items-center gap-3 rounded-2xl p-2.5 text-[#6E6A61] dark:text-[#A8A49C] hover:bg-[#E7EAE5] dark:hover:bg-white/5 hover:text-[#231F20] dark:hover:text-[#F5F6F4] transition-colors"
            >
